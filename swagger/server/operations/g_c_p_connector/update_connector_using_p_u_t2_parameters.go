...
// NewUpdateConnectorUsingPUT2Params creates a new UpdateConnectorUsingPUT2Params object
// no default values defined in spec.
func NewUpdateConnectorUsingPUT2Params() UpdateConnectorUsingPUT2Params {

	return UpdateConnectorUsingPUT2Params{}
}

// UpdateConnectorUsingPUT2Params contains all the bound params for the update connector using p u t 2 operation
// typically these are obtained from a http.Request
//
// swagger:parameters updateConnectorUsingPUT_2
type UpdateConnectorUsingPUT2Params struct {
...
//
// To ensure default values, the struct must have been initialized with NewUpdateConnectorUsingPUT2Params() beforehand.
func (o *UpdateConnectorUsingPUT2Params) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *UpdateConnectorUsingPUT2Params) bindConfigFile(file multipart.File, header *multipart.FileHeader) error {
	return nil
}

// bindConnectorID binds and validates parameter ConnectorID from path.
func (o *UpdateConnectorUsingPUT2Params) bindConnectorID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UpdateConnectorUsingPUT2Params) bindDescription(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdateConnectorUsingPUT2Params) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdateConnectorUsingPUT2Params) bindPollingFrequencyInHrs(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdateConnectorUsingPUT2Params) bindPollingFrequencyInMinutes(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdateConnectorUsingPUT2Params) bindRemediationEnabled(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}

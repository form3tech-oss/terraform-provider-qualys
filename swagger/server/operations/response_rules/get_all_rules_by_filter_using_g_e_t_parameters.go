...
// NewGetAllRulesByFilterUsingGETParams creates a new GetAllRulesByFilterUsingGETParams object
// with the default values initialized.
func NewGetAllRulesByFilterUsingGETParams() GetAllRulesByFilterUsingGETParams {
	...
	return GetAllRulesByFilterUsingGETParams{
...
// GetAllRulesByFilterUsingGETParams contains all the bound params for the get all rules by filter using g e t operation
// typically these are obtained from a http.Request
//
// swagger:parameters getAllRulesByFilterUsingGET
type GetAllRulesByFilterUsingGETParams struct {
	...
	*/
	CloudType string
	/*Filter the Rules list by providing a query using Qualys syntax.
	  In: query
	*/
	Filter *string
...
//
// To ensure default values, the struct must have been initialized with NewGetAllRulesByFilterUsingGETParams() beforehand.
func (o *GetAllRulesByFilterUsingGETParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAllRulesByFilterUsingGETParams) bindCloudType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetAllRulesByFilterUsingGETParams) validateCloudType(formats strfmt.Registry) error {
...
func (o *GetAllRulesByFilterUsingGETParams) bindFilter(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAllRulesByFilterUsingGETParams) bindPageNo(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetAllRulesByFilterUsingGETParams) bindPageSize(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetAllRulesByFilterUsingGETParams) bindRuleType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetAllRulesByFilterUsingGETParams) validateRuleType(formats strfmt.Registry) error {
...
func (o *GetAllRulesByFilterUsingGETParams) bindSortField(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAllRulesByFilterUsingGETParams) bindSortOrder(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}

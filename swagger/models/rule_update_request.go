...
//
// swagger:model RuleUpdateRequest
...
// Validate validates this rule update request
func (m *RuleUpdateRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RuleUpdateRequest) validateActionRequests(formats strfmt.Registry) error {
...
func (m *RuleUpdateRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RuleUpdateRequest) UnmarshalBinary(b []byte) error {
	var res RuleUpdateRequest

...
// GcpEvaluationDetailResponse GcpEvaluationDetailResponse
//
// swagger:model GcpEvaluationDetailResponse
type GcpEvaluationDetailResponse struct {
...
// Validate validates this gcp evaluation detail response
func (m *GcpEvaluationDetailResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GcpEvaluationDetailResponse) validateEvaluationDates(formats strfmt.Registry) error {
...
func (m *GcpEvaluationDetailResponse) validateEvidences(formats strfmt.Registry) error {
...
func (m *GcpEvaluationDetailResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GcpEvaluationDetailResponse) UnmarshalBinary(b []byte) error {
	var res GcpEvaluationDetailResponse

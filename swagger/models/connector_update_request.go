...
//
// swagger:model ConnectorUpdateRequest
...
// Validate validates this connector update request
func (m *ConnectorUpdateRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConnectorUpdateRequest) validatePollingFrequency(formats strfmt.Registry) error {
...
func (m *ConnectorUpdateRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ConnectorUpdateRequest) UnmarshalBinary(b []byte) error {
	var res ConnectorUpdateRequest
